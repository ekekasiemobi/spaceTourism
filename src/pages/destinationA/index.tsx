            ...
            <div className="flex justify-between w-[80vw] mx-auto items-center pt-10">
                ...
                <div className=' flex flex-col gap-7 w-[30vw]'>
                    ...
                    <ul className='flex gap-5'>
                        <li><a className='text-[#A6ABCA] barlow' href="">MOON</a></li>
                        <li><a className='text-[#A6ABCA] barlow' href="">MARS</a></li>
                        <li><a className='text-[#A6ABCA] barlow' href="">EUROPA</a></li>
                        <li><a className='text-[#A6ABCA] barlow' href="">TITIAN</a></li>
                    </ul>
